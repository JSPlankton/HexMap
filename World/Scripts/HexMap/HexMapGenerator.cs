...
namespace JS.HexMap
{
    public class HexMapGenerator : MonoBehaviour
    {
        ...
        [Range(0f, 1f)][Tooltip("气候-初始湿度")]
        public float startingMoisture = 0.1f;
        [Range(0f, 1f)][Tooltip("气候-水分蒸发")]
        public float evaporationFactor  = 0.5f;
        [Range(0f, 1f)][Tooltip("气候-水分沉降")]
        public float precipitationFactor = 0.25f;
        [Range(0f, 1f)][Tooltip("气候-水分流失(流向较低区域)")]
        public float runoffFactor = 0.25f;
        [Range(0f, 1f)][Tooltip("气候-水分渗透")]
        public float seepageFactor = 0.125f;
        [Tooltip("气候-风向")]
        public HexDirection windDirection = HexDirection.NW;
        [Range(1f, 10f)][Tooltip("气候-风的强度")]
        public float windStrength = 4f;
        [Range(0, 20)][Tooltip("河流预算")]
        public int riverPercentage = 10;
        [Range(0f, 1f)][Tooltip("额外湖泊生成概率")]
        public float extraLakeProbability = 0.25f;
        [Range(0f, 1f)][Tooltip("低温")]
        public float lowTemperature = 0f;
        [Range(0f, 1f)][Tooltip("高温")]
        public float highTemperature = 1f;
        [Tooltip("南北半球")]
        public HemisphereMode hemisphere;
        [Range(0f, 1f)][Tooltip("随机温度波动")]
        ...
        void ErodeLand()
        {
            ...
            while (erodibleCells.Count > targetErodibleCount) {
                ...
                for (HexDirection d = HexDirection.NE; d <= HexDirection.NW; d++) {
                    HexCell neighbor = cell.GetNeighbor(d);
                    if (
                        neighbor && IsErodible(neighbor) && neighbor.Elevation == cell.Elevation + 2 &&
